...
input string CustomComment = "ORB_Benchmark";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 1221;        //MagicNumber
...
int variable1 = 0;        //variable1
input double epsilon1 = 0;        //epsilon1
input double epsilon2 = 0;        //epsilon2
double TSL = 0;        //TSL
input int Openrangeminutes = 30;        //Openrangeminutes
double h = 0;        //h
double l = 0;        //l
double sigma = 0.5;        //sigma
double Bu = 0;        //Bu
double Bl = 0;        //Bl
bool Rangeready = 0;        //Rangeready
int barcount = 0;        //barcount
bool bartime = true;        //bartime
double SL = 0;        //SL
input int tsl_mode = 3;        //tsl_mode
input int RDD_mode = 3;        //RDD_mode
double RDD_factor = 2;        //RDD_factor
int TP_Active = 0;        //TP_Active
double TP_threshold_factor = 0;        //TP_threshold_factor
double max_price = 0;        //max_price
double min_price = 0;        //min_price
input double AssignVrbVleEntMlt1 = 0;        //AssignVrbVleEntMlt1
input double AssignVrbVleEntMlt2 = 1;        //AssignVrbVleEntMlt2
input double AssignVrbVleEntMlt3 = 0.33;        //AssignVrbVleEntMlt3
input double AssignVrbVleEntMlt4 = 0.66;        //AssignVrbVleEntMlt4
input double AssignVrbVleEntMlt5 = 999999;        //AssignVrbVleEntMlt5
...
input double MainChartTickSizeSQ = 0.1; //MainChartPipSizeSQ
...
#define STDDEV_1 0     //iStdDev(NULL,0, Openrangeminutes, 0, MODE_SMA, PRICE_CLOSE)
...
string sqStrategyName = "ORB_Benchmark";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (NormalizeDouble((double) sqTimeDayOfWeek(sqTime(NULL,0, 0)), 6) != NormalizeDouble((double) sqTimeDayOfWeek(sqTime(NULL,0, 1)), 6))
)
   {
      // Action #1
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) barcount, 6) == NormalizeDouble((double) 0, 6))
      &&   (NormalizeDouble((double) sqTimeHour(sqTime(NULL,0, 0)), 6) == NormalizeDouble((double) 8, 6)))
      &&   (NormalizeDouble((double) sqTimeMinute(sqTime(NULL,0, 0)), 6) >= NormalizeDouble((double) 1, 6)))
)
   {
      // Action #1
        h = (double) sqHigh(NULL,0, 1);


      // Action #2
        l = (double) sqLow(NULL,0, 1);
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((!(Rangeready))
      &&   ((NormalizeDouble((double) barcount, 6) < NormalizeDouble((double) Openrangeminutes, 6))
      &&   (NormalizeDouble((double) barcount, 6) > NormalizeDouble((double) 0, 6))))
)
   {
      // Action #1
        h = (double) MathMax(h, sqHigh(NULL,0, 0));


      // Action #2
        l = (double) MathMin(l, sqLow(NULL,0, 0));
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((!(Rangeready))
      &&   (NormalizeDouble((double) barcount, 6) == NormalizeDouble((double) Openrangeminutes, 6)))
      &&   (NormalizeDouble((double) tsl_mode, 6) == NormalizeDouble((double) 0, 6)))
)
   {
      // Action #1
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((!(Rangeready))
      &&   (NormalizeDouble((double) barcount, 6) == NormalizeDouble((double) Openrangeminutes, 6)))
      &&   (NormalizeDouble((double) tsl_mode, 6) == NormalizeDouble((double) 1, 6)))
)
   {
      // Action #1
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((!(Rangeready))
      &&   (NormalizeDouble((double) barcount, 6) == NormalizeDouble((double) Openrangeminutes, 6)))
      &&   (NormalizeDouble((double) tsl_mode, 6) == NormalizeDouble((double) 2, 6)))
)
   {
      // Action #1
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((!(Rangeready))
      &&   (NormalizeDouble((double) barcount, 6) == NormalizeDouble((double) Openrangeminutes, 6)))
      &&   (NormalizeDouble((double) tsl_mode, 6) == NormalizeDouble((double) 3, 6)))
)
   {
      // Action #1
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((!(Rangeready))
      &&   (NormalizeDouble((double) barcount, 6) == NormalizeDouble((double) Openrangeminutes, 6)))
      &&   (NormalizeDouble((double) RDD_mode, 6) == NormalizeDouble((double) 0, 6)))
)
   {
      // Action #1
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((!(Rangeready))
      &&   (NormalizeDouble((double) barcount, 6) == NormalizeDouble((double) Openrangeminutes, 6)))
      &&   (NormalizeDouble((double) RDD_mode, 6) == NormalizeDouble((double) 1, 6)))
)
   {
      // Action #1
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((!(Rangeready))
      &&   (NormalizeDouble((double) barcount, 6) == NormalizeDouble((double) Openrangeminutes, 6)))
      &&   (NormalizeDouble((double) RDD_mode, 6) == NormalizeDouble((double) 2, 6)))
)
   {
      // Action #1
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((!(Rangeready))
      &&   (NormalizeDouble((double) barcount, 6) == NormalizeDouble((double) Openrangeminutes, 6)))
      &&   (NormalizeDouble((double) RDD_mode, 6) == NormalizeDouble((double) 3, 6)))
)
   {
      // Action #1
...
//------------------------
   ...
   {
      // Action #1
        sigma = (double) sqGetIndicatorValue(STDDEV_1, 0, 1);
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((((Rangeready
      &&   (NormalizeDouble((double) sqHigh(NULL,0, 1), 6) > NormalizeDouble((double) Bu, 6)))
      &&   (NormalizeDouble((double) sqTimeHour(sqTime(NULL,0, 0)), 6) >= NormalizeDouble((double) 8, 6)))
      &&   (NormalizeDouble((double) sqTimeMinute(sqTime(NULL,0, 0)), 6) >= NormalizeDouble((double) 30, 6)))
      &&   (NormalizeDouble((double) sqTimeHour(sqTime(NULL,0, 0)), 6) < NormalizeDouble((double) 16, 6)));

     ShortEntrySignal = ((((Rangeready
      &&   (NormalizeDouble((double) sqLow(NULL,0, 1), 6) < NormalizeDouble((double) Bl, 6)))
      &&   (NormalizeDouble((double) sqTimeHour(sqTime(NULL,0, 0)), 6) >= NormalizeDouble((double) 8, 6)))
      &&   (NormalizeDouble((double) sqTimeMinute(sqTime(NULL,0, 0)), 6) >= NormalizeDouble((double) 30, 6)))
      &&   (NormalizeDouble((double) sqTimeHour(sqTime(NULL,0, 0)), 6) < NormalizeDouble((double) 16, 6)));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY, openPrice, 3,   (sqGetPositionOpenPrice("Current", MagicNumber, 1, "") - SL)), "Current");
      ...
      // Action #2
        max_price = (double) sqGetPositionOpenPrice("Current", MagicNumber, 1, "");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL, openPrice, 3,   (sqGetPositionOpenPrice("Current", MagicNumber, -1, "") + SL)), "Current");
      pt = sqFixMarketPrice(0, "Current");
      size = mmLots * mmMultiplier;
      ...
      // Action #2
        min_price = (double) sqGetPositionOpenPrice("Current", MagicNumber, -1, "");
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (NormalizeDouble((double) sqGetMarketPosition("Current", MagicNumber, ""), 6) != NormalizeDouble((double) 0, 6))
)
   {
      // Action #1
        max_price = (double) MathMax(max_price, sqHigh(NULL,0, 0));


      // Action #2
        min_price = (double) MathMin(min_price, sqLow(NULL,0, 0));
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) sqGetMarketPosition("Current", MagicNumber, ""), 6) > NormalizeDouble((double) 0, 6))
      &&   (NormalizeDouble((double) TP_Active, 6) == NormalizeDouble((double) 0, 6)))
      &&   (NormalizeDouble((double) (sqClose(NULL,0, 0) - sqGetPositionOpenPrice("Current", MagicNumber, 1, "")), 6) >= NormalizeDouble((double) (TP_threshold_factor * (Bu - Bl)), 6)))
)
   {
      // Action #1
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) sqGetMarketPosition("Current", MagicNumber, ""), 6) < NormalizeDouble((double) 0, 6))
      &&   (NormalizeDouble((double) TP_Active, 6) == NormalizeDouble((double) 0, 6)))
      &&   (NormalizeDouble((double) (sqGetPositionOpenPrice("Current", MagicNumber, -1, "") - sqClose(NULL,0, 0)), 6) >= NormalizeDouble((double) (TP_threshold_factor * (Bu - Bl)), 6)))
)
   {
      // Action #1
        TP_Active = (int) AssignVrbVleEntMlt2;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((((NormalizeDouble((double) TP_Active, 6) == NormalizeDouble((double) 1, 6))
      &&   (NormalizeDouble((double) sqGetBarsSinceOpen("Current", MagicNumber, 0, ""), 6) > NormalizeDouble((double) 0, 6)))
      &&   (((NormalizeDouble((double) sqClose(NULL,0, 0), 6) <= NormalizeDouble((double) (max_price - (RDD_factor * (max_price - sqGetPositionOpenPrice("Current", MagicNumber, 1, "")))), 6))
      &&   (NormalizeDouble((double) sqGetMarketPosition("Current", MagicNumber, ""), 6) > NormalizeDouble((double) 0, 6)))
      ||    ((NormalizeDouble((double) sqClose(NULL,0, 0), 6) >= NormalizeDouble((double) (min_price + (RDD_factor * (sqGetPositionOpenPrice("Current", MagicNumber, -1, "") - min_price))), 6))
      &&   (NormalizeDouble((double) sqGetMarketPosition("Current", MagicNumber, ""), 6) < NormalizeDouble((double) 0, 6)))))
      &&   (NormalizeDouble((double) sqGetOpenPLInPips("Current", MagicNumber, 0, ""), 6) > NormalizeDouble((double) 0, 6)))
)
   {
      // Action #1
        // Close all positions
...
bool initIndicators(){
   ...
   indicatorHandles[STDDEV_1] = iStdDev(NULL,0, Openrangeminutes, 0, MODE_SMA, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("(sqGetPositionOpenPrice(\"Current\", MagicNumber, 1, \"\") - SL)")) {
      return ((sqGetPositionOpenPrice("Current", MagicNumber, 1, "") - SL));
   }
   if(idHash == sqStringHash("(sqGetPositionOpenPrice(\"Current\", MagicNumber, -1, \"\") + SL)")) {
      return ((sqGetPositionOpenPrice("Current", MagicNumber, -1, "") + SL));
   }
...
//+----------------------------- Include from /MetaTrader5/CustomFunctions/IsBearishDivergence.mq5 -------------------------------------+

//+------------------------------------------------------------------+
//| Checks Bearish Divergence between price and custom indicator    |
//+------------------------------------------------------------------
bool sqIsBearishDivergence(string indicator, int bars, int shift)
{
   // Arrays to store the bar indexes of two local maxima
   int priceHighs[2]      = {-1, -1};
   int indicatorHighs[2]  = {-1, -1};

   // 1) Find two local maxima in PRICE (High(i) > High(i-1) && High(i) > High(i+1))
   {
      int found = 0;
      for(int i = shift + 1; i < shift + bars - 1; i++)
      {
         ...
         if(currHigh > prevHigh && currHigh > nextHigh)
         {
            ...
            found++;
            if(found == 2) break;
            i += 2; // same skip logic as in the bullish version
         }
      }
   }

   // 2) Find two local maxima in the INDICATOR
   {
      int found = 0;
      for(int i = shift + 1; i < shift + bars - 1; i++)
      {
         double currVal = NormalizeDouble(sqGetExpressionByIdentification(indicator, i), 6);
         double prevVal = NormalizeDouble(sqGetExpressionByIdentification(indicator, i + 1), 6);
         double nextVal = NormalizeDouble(sqGetExpressionByIdentification(indicator, i - 1), 6);

         if(currVal > prevVal && currVal > nextVal)
         {
            indicatorHighs[found] = i;
            found++;
            if(found == 2) break;
            i += 2;
         }
   ...
   // If we didn't find two maxima in either price or indicator => no divergence
   if(priceHighs[0] == -1 || priceHighs[1] == -1 ||
      indicatorHighs[0] == -1 || indicatorHighs[1] == -1)
   {
      return false;
   }

   // 3) "Older" high in [1], "recent" high in [0], matching the logic used for bullish
   double priceFirstHigh     = iHigh(_Symbol, _Period, priceHighs[1]);   // older
   double priceSecondHigh    = iHigh(_Symbol, _Period, priceHighs[0]);   // recent
   double indicatorFirstHigh = NormalizeDouble(sqGetExpressionByIdentification(indicator, indicatorHighs[1]), 6);
   double indicatorSecondHigh= NormalizeDouble(sqGetExpressionByIdentification(indicator, indicatorHighs[0]), 6);

   // 4) Bearish divergence => price forms a higher high, indicator forms a lower high
   return (priceSecondHigh > priceFirstHigh && indicatorSecondHigh < indicatorFirstHigh);
}

//+----------------------------- Include from /MetaTrader5/CustomFunctions/IsBullishDivergence.mq5 -------------------------------------+

//+------------------------------------------------------------------+
//| Checks Bullish Divergence between price and custom indicator    |
//+------------------------------------------------------------------
bool sqIsBullishDivergence(string indicator, int bars, int shift)
{
   // Arrays to store the bar indexes of two local minima
   int priceLows[2]     = {-1, -1};
   int indicatorLows[2] = {-1, -1};

   // 1) Find two local minima in PRICE
   {
      int found = 0;
      for(int i = shift + 1; i < shift + bars - 1; i++)
      {
   ...
   // 2) Find two local minima in the INDICATOR
   {
      int found = 0;
      for(int i = shift + 1; i < shift + bars - 1; i++)
      {
   ...
   // If we didn't find two minima in either, no divergence
   if(priceLows[0] == -1 || priceLows[1] == -1 ||
      indicatorLows[0] == -1 || indicatorLows[1] == -1)
   {
      return false;
   }

   // 3) "Older" low is in [1], "recent" low is in [0]
   double priceFirstLow     = iLow(_Symbol, _Period, priceLows[1]);
   double priceSecondLow    = iLow(_Symbol, _Period, priceLows[0]);
   double indicatorFirstLow = NormalizeDouble(sqGetExpressionByIdentification(indicator, indicatorLows[1]), 6);
   double indicatorSecondLow= NormalizeDouble(sqGetExpressionByIdentification(indicator, indicatorLows[0]), 6);

   // 4) Bullish divergence if price forms a lower low, indicator forms a higher low
   return (priceSecondLow < priceFirstLow && indicatorSecondLow > indicatorFirstLow);
}
